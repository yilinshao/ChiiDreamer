import torch
import numpy as np
from ..utils.sugar_utils.general_utils import get_expon_lr_func
...
class SuGaROptimizer:
    ...
    def update_learning_rate(self, iteration: int = None, sdfnet_lr=1e-4):
        ...
        for param_group in self.optimizer.param_groups:
            if param_group["name"] == "points":
                ...
                param_group['lr'] = lr
            elif "sdfnetwork" in param_group["name"]:
                param_group['lr'] = sdfnet_lr
        return lr
