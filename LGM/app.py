...
# default command for LGM app gui: python app.py big --resume pretrained/model_fp16_fixrot.safetensors
# The default usage for tyro -> add subcommands as --xxx ..... then opt.xxx give .....
...
def process(input_image, prompt, prompt_neg='', input_elevation=0, input_num_steps=30, input_seed=42):
    ...
    input_image = torch.cat([input_image, rays_embeddings], dim=1).unsqueeze(0) # [1, 4, 9, H, W]
        ...
        # Gaussian generation part inference.
    with torch.no_grad():
...
# share=True representing a public share link that can be visited by local PC.
